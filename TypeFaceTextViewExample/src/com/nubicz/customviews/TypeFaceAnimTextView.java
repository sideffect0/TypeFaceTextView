...
public class TypeFaceAnimTextView extends TextView{
	...
	public TypeFaceAnimTextView(Context context) {
		super(context);
	}
	
    public TypeFaceAnimTextView(Context context,AttributeSet attrs) {
    	super(context, attrs);
    	init(context,attrs);
	}
    
    public TypeFaceAnimTextView(Context context, AttributeSet attrs, int defStyle){
    ...
    public void init(Context context,AttributeSet attrs){
    	...
    	data = ta.getString(R.styleable.TypeFaceAnimTextView_typecustomFont);
    	is_animate = ta.getBoolean(R.styleable.TypeFaceAnimTextView_typeEffect, false);
    	mDelay = ta.getInteger(R.styleable.TypeFaceAnimTextView_typeEffectDelay,500);
